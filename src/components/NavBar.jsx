  ...
  return (
    <>
        <nav className='navbar'>
            <div className='menu-item'><a href="/homepage" className='navbar-link'>Home</a></div>
            <div className='menu-item'><a href="/play" className='navbar-link'>Play</a></div>
            <div className='menu-item'><a href="/viewfixtures" className='navbar-link'>Fixtures</a></div>
